/* ==========================================================
   ...
   ========================================================== */
(function(){
  const VERSION_KEY='nkV4BannerSeen', BADGE_KEY='nkV2CloudOpened';
  ...
  if(hdr && store.get(VERSION_KEY)!=='1'){
    ...
    b.innerHTML=`<span class="wn-badge">🚀 BIG UPDATE · v4.0</span>
      <span class="wn-text"><span class="wn-title">Meet MDCCCVII — your AI study coach, built into the Planner</span>
      ...
      <button class="btn sm" id="wnSetup">MEET MDCCCVII →</button>
